...
for file in ./data/*.txt; do
	...
	./Random_sample.py "$file-lwcc.graph" 65536 > "$RESULTS_DIR/$filename-RS-undirected.txt" &
	./Random_sample.py "$file-lscc.graph" 65536 > "$RESULTS_DIR/$filename-RS-directed.txt" &
